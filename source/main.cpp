...
#pragma config(Motor,  port3,           scissorRight,  tmotorVex393_MC29, openLoop, driveRight)
#pragma config(Motor,  port4,           scissorLeft,   tmotorVex393_MC29, openLoop, driveLeft)
